...
const FillMemoryForm = () => {
  ...
  const sportsPlayers = {
    ...
    Football: ['Manav Doshi', 'Kaustubh Chaurasia','Akhilesh ','Mokshit','Oshim','Adhi saran','Jatin Chaudhary','Shivanshu Kalia','Onam Tamir','Subhojit','Pushpak','Babu','Pratham Sanghvi','Sarjam Tudu'],
